														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	 ${requestScope.class_add_msg }
																	<form action="${pageContext.request.contextPath }/class/addClass.do" method="post" class="form-horizontal" role="form">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="class_name" type="text" id="form-field-1" placeholder="班级名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="class_student_number" type="text" id="form-field-1" placeholder="人数" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			<div class="col-sm-7 text-right">
																				<button type="submit" class="btn btn-primary">增加班级</button>
																			</div>
																		</div>
																	</form>
