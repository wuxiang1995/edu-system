												...
												<div class="widget-header">
													...
													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li >
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/dictionary/toDictionaryAdd.do'">增加</a>
															</li>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<button id="btnDeleteChkDictionary" class="btn btn-primary">删除勾选字典</button>
																...
																<c:forEach var="dictionary" varStatus="status" items="${requestScope.page.data }">
																    <tr>
																	  <td><input name="dictionaryId" value="${dictionary.dic_id}" type="checkbox"></td>
																	  <td>${dictionary.dic_id}</td>
																	  <td>${dictionary.dic_name}</td>
																	   <td>${dictionary.dic_value}</td>
																	  <td>${dictionary.dic_type_code}</td>
																	   <td>${dictionary.dic_type_name}</td>
																	   <td><button class="btn btn-sm btn-primary" onclick="window.location.href='${pageContext.request.contextPath }/dictionary/toDictionaryEdit.do?dictionaryId=${dictionary.dic_id}'">更新</button>&nbsp;&nbsp;<button class="btn btn-sm btn-primary" onclick="window.location.href='${pageContext.request.contextPath }/dictionary/deleteDictionary.do?dictionaryId=${dictionary.dic_id}'" >删除</button></td>
																	</tr>
																   <tr>
																   </c:forEach>
																 </table>
...
<![endif]-->
		...
		<!-- inline scripts related to this page -->
		       ...
		       $("#btnDeleteChkDictionary").click(function(){
		    	   //alert("--test--");
		    	   //1.获得选中的复选框的值
		    	   var chkDictionarys= $("input[name='dictionaryId']:checked");
		    	   var params=chkDictionarys.serialize();
		    	   //2.将chkDictionary转换成发送的参数
