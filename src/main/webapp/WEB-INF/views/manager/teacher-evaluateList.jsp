					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">教学评测</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li class="active">
																<a data-toggle="tab" href="#evaluateList">列表</a>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<div id="evaluateList" class="tab-pane in active">
																 ...
																 <table class="table table-striped table-bordered align-center "> 
																   ...
																   <c:forEach var="evaluate" varStatus="status" items="${requestScope.page.data }">
																    <tr>
																	  <td>${evaluate. evaluate_create_date}</td>
																	  <td>${evaluate.classMap.class_name}</td>
																	  <td>${evaluate.evaluate_title}</td>
																	   <td><button class="btn btn-sm btn-primary" onclick="window.location.href='${pageContext.request.contextPath }/studentevaluate/toDetailsEvaluateList.do?evaluateId=${evaluate.evaluate_id}'" >查看详情</button></td>
																	</tr>
																   <tr>
																   </c:forEach>
																 </table>
																	  ...
																	  <ul class="pagination">
																	      ...
																	      <c:choose>
																	         <c:when test="${requestScope.page.previous==true }">
																	             <li>
																	               <a href="${pageContext.request.contextPath }/evaluate/toEvaluateList.do?index=${requestScope.page.index-1}" aria-label="Previous">
																	       ...
																	       <c:choose>
																	          ...
																	          <c:when test="${status.count==requestScope.page.index+1}">
							                                                         <%-- 注意事项：数据库的索引是从0开始的，而页面索引是从1开始的。索引数据索引=页面索引-1 --%>
																	      			<li class="active">
																	      			<a href="${pageContext.request.contextPath }/evaluate/toEvaluateList.do?index=${status.count-1}">${status.count }</a>
																	      			</li>										          
																	          </c:when>
																	          <c:otherwise>
																	                <li>
																	    ...
																	    <c:choose>
																	      <c:when test="${requestScope.page.next==true }">
																           <li>
																	      	  <a href="${pageContext.request.contextPath }/evaluate/toEvaluateList.do?index=${requestScope.page.index+1}" 
																	      	      aria-label="Next">
