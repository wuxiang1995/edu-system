														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	...
																	<form action="${pageContext.request.contextPath }/dictionary/addDictionary.do" method="post" class="form-horizontal" role="form">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="dic_name" type="text" id="form-field-1" placeholder="字典名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="dic_value" type="text" id="form-field-1" placeholder="字典值" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="dic_type_code" type="text" id="form-field-1" placeholder="字典类型编码" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="dic_type_name" type="text" id="form-field-1" placeholder="字典类型名称" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right">
																				<button class="btn btn-primary">增加数据字典</button>
																			</div>
																		</div>
																	</form>
