														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	 ${requestScope.student_add_msg }
																	<form action="${pageContext.request.contextPath }/student/addStudent.do" method="post" class="form-horizontal" role="form">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="student_name" type="text" id="form-field-1" placeholder="用户名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="student_age" type="text" id="form-field-1" placeholder="年龄" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 电话 </label>
																			<div class="col-sm-9">
																				<input name="student_phone" type="text" id="form-field-1" placeholder="电话" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		<div class="form-group">
