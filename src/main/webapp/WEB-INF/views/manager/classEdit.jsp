												...
												<div class="widget-header">
													...
													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															...
															<li>
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/class/toClassList.do'">列表</a>
															</li>
														</ul>
													</div>
												</div>
														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	 ${requestScope.class_edit_msg }
																	<form action="${pageContext.request.contextPath }/class/editClass.do" method="post" class="form-horizontal" role="form">
																		<input name="class_id" type="hidden" value="${requestScope.classs.class_id}">
																		<input name="token.invoke" type="hidden" value="/admin/toAdminList.do">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">班级昵称</label>
																			<div class="col-sm-9">
																				<input name="class_name" type="text" id="form-field-1"  value="${requestScope.classs.class_name}" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">班级规模（人数）</label>
																			<div class="col-sm-9">
																				<input name="class_student_number" type="text" id="form-field-1" value="${requestScope.classs.class_student_number}" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
